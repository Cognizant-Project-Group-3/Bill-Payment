	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">				
					...
					<li><form action="homepage.html"><input type="submit" name="Home" value="Home"> </form></li>
...
<li><form action="Logout" method="post"><input type="submit" name="Logout" value="Logout"> </form></li>				
	...
	<div id="PaymentConfirmation" class="container-fluid text-center bg-grey">
		<div class="center">
	<h4 class="success" >Payment Successful !</h4><br>
		</div>
		<form action="Billpdf" method="post"  target="_blank">
			<table align="center" >
				<tr align="left" >
							<td><br><div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">Customer
										Id</span> <input type="text" name="cid" class="form-control"
										placeholder="${Customer_Id}" value="  ${cname} "
						...
						<tr align="left" >
							<td><div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">Customer
										Name</span> <input type="text" name="customerName"class="form-control"
										placeholder="${Customer_Id}" value="  ${customerName} "
										aria-describedby="sizing-addon1" readonly>
								</div>
							</td>
						</tr>
						...
						<tr align="left">
							<td><div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">Vendor Type</span> <input type="text" name="vtype"class="form-control"
										placeholder="${Customer_Id}" value="  ${vtype} "
										aria-describedby="sizing-addon1" readonly>
								</div>
							</td>
						</tr>
						...
						<tr align="left">
							<td><div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">Vendor Name</span> <input type="text" name="vname"class="form-control"
										placeholder="${Customer_Id}" value="  ${vname} "
										aria-describedby="sizing-addon1" readonly>
								</div>
							</td>
						</tr>
						...
						<tr align="left">
							<td><div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">Amount Paid</span> <input type="text" name="amount" class="form-control"
										placeholder="${Customer_Id}" value="  ${amount} "
										aria-describedby="sizing-addon1" readonly>
								</div>
								<br>
							</td>
			...
			<input type="submit" value="Download bill [pdf]"> 
		</form>
...
<div class="row slideanim">
	...
	<p>
		Bootstrap Theme Made By <a href="#mypage" title="Visit w3schools">Prashant
			Patil (513035)</a>
	</p>
	</footer>
