...
<script  src="update_customer_details.js" type="text/javascript">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">				
					...
					<li><form action="homepage.html"><input type="submit" class="button1 btn-default" name="Home" value="Home"> </form></li>
					<li><a href="#customer">Customer</a></li>
					<!-- <li><a href="#vendor">Vendor</a></li> -->					
<li><form action="Logout" method="post"><input type="submit" class="button1 btn-default" name="Logout" value="Logout"> </form></li>				
			</ul>
		</div>
	</div>
	</nav>
...
<!-- Main Code  -->
<br><br><br><br>
<div id="UpdateCustomer" class="container-fluid text-center bg-grey">
			<div class="row center">
		<div class="col-sm-12	">
		<!-- <h2>Bill Payment System</h2> --> 		
		<h4>Update Customer Registraion Form</h4>
<c:choose>
            <c:when test="${message == null}">
          <form name="customer_update"  onsubmit="return validateForm();" action="UpdateCustomerServlet" >
          
          <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Customer ID</span> 
	   		<input type="text" name="id" value="${id}" readonly class="form-control" placeholder="Customer ID" aria-describedby="sizing-addon1">
		</div>
          
          
          <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Customer Name</span> 
	   		<input type="text" id="name" name="name" value="${name}" class="form-control" placeholder="Customer Name" aria-describedby="sizing-addon1">
		</div>
          
          <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Address</span> 
	   		<input type="text"  id="address" name="address" value="${address}" class="form-control" placeholder="Address" aria-describedby="sizing-addon1">
		</div>
          
         <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Contact No.</span> 
	   		<input type="text" id="contact_no" name="contact_no" value="${contact_no}" class="form-control" placeholder="Contact No." aria-describedby="sizing-addon1">
		</div>
          ...
          <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Email-ID</span> 
	   		<input type="text" id="email"  name="email" value="${emailid}" class="form-control" placeholder="Email-ID" aria-describedby="sizing-addon1">
		</div>
   
           <div class="input-group input-group-lg">
	  		<span class="input-group-addon" id="sizing-addon1">Card No.</span> 
	   		<input type="text" id="card_no" name="card_no" value="${card_no}" class="form-control" placeholder="Email-ID" aria-describedby="sizing-addon1">
		</div>
          
          
          <input type="submit" value="Save" class="bg-login-button-color btn-primary btn-lg" placeholder="Save" role="button">
		<input type="reset" value="Reset" class="bg-login-button-color btn-primary btn-lg" placeholder="Reset" role="button">
				          <input type="button" value="Cancel" class="bg-login-button-color btn-primary btn-lg" placeholder="Cancel" role="button" onclick="location.href = 'homepage.html';">
