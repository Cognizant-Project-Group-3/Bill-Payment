...
<title>Register Customer Details</title>
...
<li><form action="Logout" method="post"><input type="submit" name="Logout" class="button1 btn-default" value="Logout"> </form></li>				
	...
	<div id="RegisterCustomer" class="container-fluid text-center bg-grey">
		
		<!-- <h2>Bill Payment System</h2> --> 		
		<h4 class="success" >Registration Successful ! Welcome</h4>
		<h3><font color="red" >Note your Customer ID for future reference</font></h3>
...
<tr class="success"><th>Customer Id</th><td>${id}</td></tr>

<tr ><th>Name</th><td>${name}</td></tr>

<tr><th>Contact no:</th><td>${phone}</td></tr>

<tr><th>Address</th><td>${add}</td></tr>
...
<tr><th>Card No</th><td>${card}</td></tr>


</table>

</form>
<form action="AddVendor_pro.html">
	<div>
						<p>
							<input type="submit" value="Add another Vendor"
								class="bg-login-button-color btn-primary btn-lg"
								placeholder="Add another Vendor" role="button">
						</p>
					</div>
</form>
</div><br>
