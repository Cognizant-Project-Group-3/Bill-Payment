...
<title>pending Bill Details</title>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">				
					...
					<li><a href="#PendingBills" >Pending Bills</a></li>
...
<li><form action="Logout" method="post"><input type="submit" class="button1 btn-default" name="Logout" value="Logout"> </form></li>				
	...
	<div id="PendingBills" class="container-fluid text-center bg-grey">
	
		<!-- <h2>Bill Payment System</h2> --> 		
		<h4 class="success" >Your Pending Bills :</h4><br>
<form>		
<table class="table table-hover"  >
<tr  class="Warning">
                        <td colspan="6">Customer ID : <c:out value="${customer_id}"/></td>
                        <td colspan="6">Customer Name : <c:out value="${customerName}"/></td>
                        </tr>
                       <tr class="success" > <td colspan="12">Pending Bills Details </td>
                                     </tr>
                                     
                                <tr>
                        
                        <td colspan="4">VENDOR NAME</td>
                        <td colspan="4">VENDOR TYPE</td>
                        <td colspan="4">PENDING AMOUNT</td>                        
                  </tr>
                  ...
                  <td colspan="4" >
                  <c:out value="${list.type}"/></td>
                  <td colspan="4" >
                  <c:out value="${list.pendingAmount}"/></td>
...
<form action="BillPayment_pro.html">
	<div>
						<p>
							<input type="submit" value="Pay Bill"
								class="bg-login-button-color btn-primary btn-lg"
								placeholder="Pay Bill" role="button">
						</p>
					</div>
</form>
